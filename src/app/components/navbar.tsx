...
export default function Navbar() {
  return (
    ...
    <div className="p-[2px] bg-gradient-to-r from-red-500 via-yellow-400 to-purple-500 rounded-bl-2xl rounded-br-2xl drop-shadow-2xl">
      ...
      <div className="grid grid-cols-3 items-center w-full h-16 px-3 bg-black text-white rounded-bl-2xl rounded-br-2xl">
        ...
        <div className="justify-self-center font-mono flex items-center space-x-10 h-full">
          ...
          <a href="#workexperience" className="hover:text-gray-400 transition duration-200">Work Experience</a>
          <a href="#projects" className="hover:text-gray-400 transition duration-200">Projects</a>
          <a href="#links" className="hover:text-gray-400 transition duration-200">Links</a>
        </div>
